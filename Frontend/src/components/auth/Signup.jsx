...
const Signup = () => {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            const res = await axios.post("https://jobsearchplatform.onrender.com/api/v1/user/register", formData, {
            ...
            <div className='flex items-center justify-center max-w-7xl mx-auto'>
                <form onSubmit={submitHandler} className='w-1/2 border border-gray-200 rounded-md p-4 my-10'>
                    ...
                    <div>
                        ...
                        <Input type="text" value={input.fullname} name="fullname" onChange={changeEventHandler} placeholder="Add Name" />
                    </div>
                    <div>
                        <Label>Email</Label>
